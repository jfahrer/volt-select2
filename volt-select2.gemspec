...
require 'volt/select2/version'

Gem::Specification.new do |spec|
  spec.name          = "volt-select2"
  spec.version       = Volt::Select2::VERSION
  spec.authors       = ["Julian Fahrer"]
  spec.email         = ["julian@fahrer.net"]
  spec.summary       = %q{Simple wrapper to use select2 with Volt}
  spec.description   = %q{Simple wrapper to use select2 with Volt}
  spec.homepage      = ""
  spec.license       = "MIT"
